...
// Template define
            ...
            if (MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_FRONT_TITLE != 'false') {
              $new_prods_content .= '<div class="page-header ModuleIndexCategoriesSpecialsHeading"><h2>' . CLICSHOPPING::getDef('module_index_categories_specials_products_heading_title') . '<h2></div>';
            }
